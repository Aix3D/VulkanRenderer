...
namespace Core
{
	...
	void VulkanDescriptorPool::Build(VkDevice device)
	{
		...
		descriptorPoolCreateInfo.maxSets = m_poolSizes.size();	//	maxSets defines the maximum allowed DescriptorSets that this pool is allowed to make : http://web.engr.oregonstate.edu/~mjb/cs519v/StudentDiscussions/Hammock_InDepthOverviewOfDescriptors.4pp.pdf
